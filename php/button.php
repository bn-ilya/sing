<div class="button__container">
	<form method="GET" action="song.php" class="button__song" onsubmit="sessionFalse(this)">
			...
			if(isset($_SESSION['boolLog'], $_SESSION['boolPass'])) {
				if ($_SESSION['boolLog'] == true && $_SESSION['boolPass'] == true) { ?>
					<form action="index.php" name="actualTransf<?= $str['id'] ?>">
						<input type="submit" class="add__actual" value="+" name="<?= $str['id'] ?>" onclick="getButton(this)">
